    ...
    <div className="h-full bg-white pt-[150px]">
      <div className="w-full flex lg:flex-row flex-col justify-between lg:items-start items-center min-h-screen h-full">
        <div className="flex flex-col items-center lg:items-start justify-start lg:px-[100px] gap-2">
          ...
          {/* Fixed Round Image */}
          <div className="shadow rounded-full overflow-hidden w-[200px] h-[200px] my-5">
            <img
          ...
          <p className="text-black/60 text-bodyDefault md:text-bodyLager leading-bodyDefault text-center lg:text-start w-full min-w-[280px] md:w-3/4 xl:w-3/4">
            I'M KINI ESTHER a passionate and detail-oriented Software Engineer
            with experience in building fullstack web applications using modern
            technologies like React, Next.js, Node.js, PostgreSQL, and more. I
            love turning ideas into real, scalable digital solutions.
          </p>
          ...
          <p className="text-black/60 text-bodyDefault md:text-bodyLager leading-bodyDefault text-center lg:text-start md:w-2/4 xl:w-3/4 mt-4">
            My mission is to create software that not only functions efficiently
            but also delivers great user experiences. I’m constantly learning,
            collaborating, and contributing to the tech community to stay ahead
          ...
          <button
            ...
            style={{ boxShadow: "0 4px 15px rgba(91, 192, 255, 0.3)" }}
          >
            <Link href="/#contact">
